...
export type DialogModalPropsType = {
    visible: boolean,
    setVisible: any
...
const DialogModal = ({visible, setVisible}: DialogModalPropsType) => {
        ...
        <div className={rootClasses.join("")}>
            <div className={s.dialog__body}>
                <div className={s.dialog__content}>
                    ...
                    <p>Zkontrolujte prosím všechny vstupy a ujistěte se, že jste do každého vstupního pole zadali
                        alespoň
                        několík znaků</p>
